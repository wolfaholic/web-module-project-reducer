...
import { applyNumber, changeOperation, clearDisplay, memoryPlus, memoryReturn, memoryClear } from '../actions';
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton value={"MR"} onClick={handleMemoryReturn} />
